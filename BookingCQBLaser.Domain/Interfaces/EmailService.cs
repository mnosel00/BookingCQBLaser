        ...
        public async Task SendBookingConfirmationAsync(Booking booking, int totalCost, int depositAmount, int remainingBalance)
        {
            ...
            var htmlBody = $@"
                        ...
                        <ul>
                            ...
                            <li><strong>Wpłacono:</strong> {paidAmount} PLN</li>
                        ...
                        <ul>
                            ...
                            <li>Zadatek 300 PLN bezzwrotny</li>
                            <li>Płatność dopłaty na miejscu tylko gotówką</li>
                            <li>Punktualność wymagana</li>
                            <li>Trzeźwość i Bezpieczeństwo jest priorytetem</li>
                            <li>Osoby niepełnoletnie potrzebują zgód od rodziców/opiekunów</li>
                        </ul>
                        <br/>
